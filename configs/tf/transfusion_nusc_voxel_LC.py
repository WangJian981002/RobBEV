...
test_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromFiles'),
    #dict(type='Points_fov_drop_random',
    #     drop_prob=[1/6, 1/6, 1/6, 1/6, 1/6, 1/6]),
    #dict(type='Cam_drop_transfusion',drop_prob=0.6667),
    #dict(type='LoadAnnotations3D', with_bbox_3d=True, with_label_3d=True),
    #dict(type='Random_remove_points_in_box',drop_prob=0.5),
    dict(
...
log_level = 'INFO'
work_dir = None
load_from = 'checkpoints/transfusion_nusc_voxel_L-mAP.6466-NDS.6957.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
freeze_lidar_components = True
load_and_freeze_img_components = 'checkpoints/mask_rcnn_r50_fpn_coco-2x_1x_nuim_20201008_195238-b1742a60.pth'
