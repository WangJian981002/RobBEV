...
train_pipeline = [
    ...
    dict(
        ...
        sequential=True),
    dict(type='Points_fov_drop',
         drop_range=[(5 * 3.1415926 / 180., 60 * 3.1415926 / 180.), (60 * 3.1415926 / 180., 120 * 3.1415926 / 180.), (120 * 3.1415926 / 180., 180 * 3.1415926 / 180.),
                     (180 * 3.1415926 / 180., 240 * 3.1415926 / 180.), (240 * 3.1415926 / 180., 300 * 3.1415926 / 180.), (300 * 3.1415926 / 180., 360 * 3.1415926 / 180.)],
         drop_prob=[0.8,0.8,0.8,0.8,0.8,0.8]),
    dict(
...
test_pipeline = [
    ...
    dict(type='Points_fov_drop',
         drop_range=[(0 * 3.1415926 / 180., 210 * 3.1415926 / 180.),(330 * 3.1415926 / 180., 360 * 3.1415926 / 180.)],
         drop_prob=[1.,1.]),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
